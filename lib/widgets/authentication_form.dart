...
class AuthenticationForm extends StatelessWidget {
  ...
  InputDecoration _inputDecoration(String label, {String? error, Widget? counterWidget}) =>
      InputDecoration(
      ...
      child: Column(
        children: [
          ScaleSlideInAnimation(
            show: model.authMode == AuthMode.loginMode ||
                model.authMode == AuthMode.signUpMode,
            fromRight: false,
          ...
          ScaleSlideInAnimation(
            ...
            child: TextFormField(
              ...
              validator: (value) {
                ...
                if (model.authMode == AuthMode.signUpMode && value.length < 6)
          ...
          ScaleSlideInAnimation(
            ...
            child: TextFormField(
              ...
              validator: (value) {
                ...
                if (value.length != 6)
                  return 'Verification Code contains 6 characters';
                return null;
              },
              onChanged: (value){
